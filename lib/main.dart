...
import '../page/desktop/desktop_main.dart';
...
void main() async {
  ...
  await AudioService.init(
    builder: () => BroadcastNotifyService(),
    config: AudioServiceConfig(
      androidNotificationChannelId: 'tao.outdoor.aerial.broadcast',
      androidNotificationChannelName: 'OutdoorAerial Broadcasting',
